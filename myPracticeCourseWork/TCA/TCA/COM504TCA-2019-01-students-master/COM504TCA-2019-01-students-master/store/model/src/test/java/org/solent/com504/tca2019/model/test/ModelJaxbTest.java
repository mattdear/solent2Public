 ...
 *
 ****************************************************************************/
package org.solent.com504.tca2019.model.test;
...
public class ModelJaxbTest {
    ...
    public void testJaxb() {
        ...
        try {
            ...
            JAXBContext jaxbContext = JAXBContext.newInstance("org.solent.com504.tca2019.model");
            ...
            List<Item> entities = replyMessage1.getItemList().getItems();

            for (int intityId = 0; intityId < 3; intityId++) {
                Item item = new Item();
                item.setId(intityId);
                item.setSku("sku_" + intityId);
                item.setDescription("description_" + intityId);;
                item.setPrice(Double.valueOf(intityId));
                entities.add(item);
            }
