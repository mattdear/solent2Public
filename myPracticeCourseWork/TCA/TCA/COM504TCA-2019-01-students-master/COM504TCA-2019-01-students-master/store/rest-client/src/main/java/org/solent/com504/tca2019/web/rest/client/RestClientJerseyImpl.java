 ...
 */
package org.solent.com504.tca2019.web.rest.client;

import org.solent.com504.tca2019.model.Item;
import org.solent.com504.tca2019.model.ReplyMessage;
import org.solent.com504.tca2019.model.RestInterface;
...
public class RestClientJerseyImpl implements RestInterface {
    ...
    /**
     * @param baseUrl the url which will be targeted for the rest api e.g. "http://localhost:8084/"
    ...
    public ReplyMessage retrieveMatchingItems(Item itemTempate) {
        ...
        try {
            ...
            response = builder.post(javax.ws.rs.client.Entity.entity(itemTempate, mediaType));
    ...
    public ReplyMessage retrieveItem(Integer id) {
        ...
        try {
            ...
            throw new RuntimeException("cannot run rest client to retrieveItem: Exception:", e);
        }
